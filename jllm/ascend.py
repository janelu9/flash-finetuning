...
def megatron_core_adaptation(aspm, mindspeed_args):
    ...
    from mindspeed.core.tensor_parallel.random import _set_cuda_rng_state, checkpoint_function_backward, checkpoint_wrapper
    ...
    from mindspeed.core.fusions.rotary_pos_embedding import apply_fused_rotary_pos_emb_bshd_wrapper, rotary_embedding_init_wrapper
    from mindspeed.core.fusions.fused_bias_swiglu import SwiGLUFunction, BiasSwiGLUFunction
    from mindspeed.core.transformer.attention import attention_init_wrapper, self_attention_init_wrapper
    ...
    from mindspeed.core.performance.auto_pipeline_perf.schedules import get_forward_backward_func_decorator, backward_step_decorator, forward_step_decorator
...
def megatron_legacy_adaptation(aspm):
    ...
    from mindspeed.model.transformer import parallel_mlp_init_wrapper, flash_self_attention_forward, flash_self_attention_init_wrapper, parallel_mlp_forward_wrapper, parallel_transformer_init_wrapper, \
        parallel_transformer_forward_wrapper
    from mindspeed.model.transformer import core_attention_init_wrapper, core_attention_forward, parallel_attention_init_wrapper, \
...
def megatron_training_adaptation(aspm):
    ...
    from mindspeed.utils import get_batch_on_this_cp_rank, get_batch_on_this_tp_rank
    ...
    from mindspeed.core.training import pretrain_decorator, train_decorator, train_step_decorator, \
